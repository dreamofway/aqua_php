  ...
  <div class="container">
    <ul class="location">
  		...
  		<li><a class="location_list">커뮤니티</a></li>  		  			
  		<li>
        <a class="location_list">
          <?php
            foreach( $sub_menu_arr['communication'] AS $data ) {            
                if( $left_code ==  $data['code'] ){
    ...
    <div class="content">
      <div class="content_head">
  			<h2 class="page_title"><?=$sub_title?></h2>
        <p class="page_info">
            ...
            <table class="wrsp_tbl">
              ...
              <tbody>
                ...
                <tr>                
                  <td><?=$value["idx"]?></td>
                  <td>
                    <a href="./list_view?idx=<?=$value["idx"]?>&page=<?=$page.$params?>">
